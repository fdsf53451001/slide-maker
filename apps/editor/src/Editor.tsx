...
import { TextToolIcon } from "./editor/icons.js";
...
import { VersionStrip } from "./editor/VersionStrip.js";
...
import { OutlineFields } from "./editor/OutlineFields.js";
  ...
  return (
    <div className={`shell${inspectorCollapsed ? " inspector-collapsed" : ""}`}>
      ...
      <SlideRail
        ...
        thumbBusy={thumbBusy}
        newSlideBusy={newSlideBusy}
        slideCountTitle={slideCountTitle}
      ...
      <main className="stage">
        ...
        */}
        ...
        <VersionStrip
          ...
          onPreviewVersionId={setPreviewVersionId}
          onDeletingVersionId={setDeletingVersionId}
          run={run}
        />
      </main>
          ...
          <>
            ...
            {outlineView && draft && (
              <OutlineFields
                ...
                dirtyFieldLabels={dirtyFieldLabels}
                dirtyNoteId={outlineDirtyNoteId}
      ...
      {stylePickerVersion && (
        <StylePickerDialog
          dialogRef={stylePickerRef}
          styles={styles}
          busy={stylePickerBusy}
          onPick={addCurrentImageToStyle}
          onClose={() => setStylePickerVersion(undefined)}
        />
      )}
